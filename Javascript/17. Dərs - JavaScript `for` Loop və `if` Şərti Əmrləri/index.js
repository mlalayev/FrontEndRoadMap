...
}`//? `if (x > 10)` - Əgər x 10-dan böyükdürsə, şərt doğru olacaq və əməl icra olunacaq. //? **Açıqlama**:
...
}`//? `if (y > 0)` - Əgər y müsbət ədəd olsa, ilk əməl icra olunacaq. //? **Açıqlama**:
...
if (z < 0) {
    ...
    console.log("Müsbət ədəd");
}`//? İlk şərt `z < 0` yoxlanılır, əgər doğru olsa, birinci əməl icra olunur. //? **Açıqlama**:
